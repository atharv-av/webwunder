    ...
    return (
        <>
            ...
            >
                ...
                >
                    <div
                        className={`container flex w-full items-center justify-between px-14 py-2`}
                    >
                        <div
                            className={`flex w-full items-center justify-between rounded-xl bg-transparent ${isScrolling ? 'backdrop-blur-sm' : ''}`}
                        >
                            <Logo />
