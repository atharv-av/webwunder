...
export const InfiniteMovingCards = ({
    ...
    {/* Left Gradient */}
    <div className="absolute inset-y-0 left-0 w-16 bg-gradient-to-r from-black/80 to-transparent pointer-events-none z-10"></div>

    {/* Right Gradient */}
    <div className="absolute inset-y-0 right-0 w-16 bg-gradient-to-l from-black/80 to-transparent pointer-events-none z-10"></div>

    {/* Scrolling List */}
    <ul
        ref={scrollerRef}
        className={cn(
            'flex w-max animate-scroll flex-nowrap gap-4 py-4 z-0',
