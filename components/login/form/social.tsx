...
export default function Socials() {
    ...
    const SocialData = [
        {
            icon: <BsGoogle className="rounded-md bg-[#29292F] md:p-3 md:text-5xl p-2 text-3xl" />,
            label: 'Sign in with Google',
            provider: 'google',
        },
        {
            icon: <BsApple className="rounded-md bg-[#29292F] md:p-3 md:text-5xl p-2 text-3xl" />,
            label: 'Sign in with Apple',
            provider: 'apple',
        },
        {
            icon: (
                <BsMicrosoft className="rounded-md bg-[#29292F] md:p-3 md:text-5xl p-2 text-3xl" />
            ),
            label: 'Sign in with Microsoft',
            provider: 'microsoft',
        },
        {
            icon: <FaAmazon className="rounded-md bg-[#29292F] md:p-3 md:text-5xl p-2 text-3xl" />,
            label: 'Sign in with Amazon',
            provider: 'amazon',
        },
        {
            icon: (
                <RiFacebookFill className="rounded-md bg-[#29292F] md:p-3 md:text-5xl p-2 text-3xl" />
            ),
        ...
        {
            icon: (
                <FaXTwitter className="rounded-md bg-[#29292F] md:p-3 md:text-5xl p-2 text-3xl" />
            ),
        ...
        {
            icon: (
                <BsDiscord className="rounded-md bg-[#29292F] md:p-3 md:text-5xl p-2 text-3xl" />
            ),
            label: 'Sign in with Discord',
            provider: 'discord',
        },
        {
            icon: <BsGithub className="rounded-md bg-[#29292F] md:p-3 md:text-5xl p-2 text-3xl" />,
