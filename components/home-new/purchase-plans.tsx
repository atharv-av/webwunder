    ...
    const plans: PlanProps[] = [
        {
            ...
            description: languageData?.paymentsCard?.[changeLanguage]?.tabs[0]?.description,
            price: languageData?.paymentsCard?.[changeLanguage]?.tabs[0]?.price,
            setupFee: languageData?.paymentsCard?.[changeLanguage]?.tabs[0]?.setupFee,
            features: languageData?.paymentsCard?.[changeLanguage]?.tabs[0]?.features,
        },
        {
            icon: '/images/home/purchase-plans/icon-3.png',
            iconBg: 'bg-[#27DAB7]',
            title: languageData?.paymentsCard?.[changeLanguage]?.tabs[1]?.title,
            description: languageData?.paymentsCard?.[changeLanguage]?.tabs[1]?.description,
            price: languageData?.paymentsCard?.[changeLanguage]?.tabs[1]?.price,
            setupFee: languageData?.paymentsCard?.[changeLanguage]?.tabs[1]?.setupFee,
            features: languageData?.paymentsCard?.[changeLanguage]?.tabs[1]?.features,
            ctaText: 'Best Seller',
        },
        {
            icon: '/images/home/purchase-plans/icon-3.png',
            ...
            description: languageData?.paymentsCard?.[changeLanguage]?.tabs[2]?.description,
            price: languageData?.paymentsCard?.[changeLanguage]?.tabs[2]?.price,
            setupFee: languageData?.paymentsCard?.[changeLanguage]?.tabs[2]?.setupFee,
            features: languageData?.paymentsCard?.[changeLanguage]?.tabs[2]?.features,
        },
        {
            icon: '/images/home/purchase-plans/icon-4.png',
            iconBg: 'bg-[#5D59E1]',
            title: languageData?.paymentsCard?.[changeLanguage]?.tabs[3]?.title,
            description: languageData?.paymentsCard?.[changeLanguage]?.tabs[3]?.description,
            price: languageData?.paymentsCard?.[changeLanguage]?.tabs[3]?.price,
            setupFee: languageData?.paymentsCard?.[changeLanguage]?.tabs[3]?.setupFee,
            features: languageData?.paymentsCard?.[changeLanguage]?.tabs[3]?.features,
        },
    ]
